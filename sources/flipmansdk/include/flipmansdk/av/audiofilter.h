...
public:
    ...
    /**
     * @brief Destroys the audio filter.
     * @note Marked virtual to allow for safe subclassing of specialized filter types.
     */
    virtual ~AudioFilter();
...
private:
    QExplicitlySharedDataPointer<AudioFilterPrivate> p;  ///< Private implementation.
};
