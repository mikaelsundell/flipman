...
public:
    ...
    struct Data {
        ...
        QPoint mousepos;
        QPointF pan;
        QColor background = palette_role(Viewport);
    ...
    Data d;
    QPointer<ViewPort> widget;
};

ViewPortPrivate::ViewPortPrivate() {}

void
ViewPortPrivate::init()
{}

void
ViewPortPrivate::init(QRhiCommandBuffer* cb)
{
...
void
ViewPortPrivate::render(QRhiCommandBuffer* cb)
{
    if (d.rhi != widget->rhi()) {
...
void
ViewPortPrivate::transform(QRhiCommandBuffer* cb)
{
...
QShader
ViewPortPrivate::shader(const QString& name)
{
...
QSize
ViewPort::resolution() const
{
    return p->d.resolution;
}

void
ViewPort::set_background(const QColor& background)
{
...
void
ViewPort::set_renderlayers(const QList<av::RenderLayer> renderlayers)
{
...
void
ViewPort::set_resolution(const QSize& resolution)
{
...
void
ViewPort::initialize(QRhiCommandBuffer* cb)
{
    p->init(cb);
}
...
void
ViewPort::render(QRhiCommandBuffer* cb)
{
    p->render(cb);
}
...
void
ViewPort::wheelEvent(QWheelEvent* event)
{
